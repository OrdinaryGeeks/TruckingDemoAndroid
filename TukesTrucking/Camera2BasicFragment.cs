...
namespace TukesTrucking
{
    public class Camera2BasicFragment : Fragment, View.IOnClickListener, FragmentCompat.IOnRequestPermissionsResultCallback
    {
        ...
        public static readonly int Storage_Permission = 10002;
       ...
       public  File jFolder;
        ...
        public override void OnActivityCreated(Bundle savedInstanceState)
        {
            ...
            jFolder = new Java.IO.File(Android.OS.Environment.GetExternalStoragePublicDirectory(Android.OS.Environment.DirectoryPictures), "TukesTrucking");

            if (!jFolder.Exists())
                jFolder.Mkdirs();

            File jFile = new File(jFolder, "pic2.jpg");
            ...
            if (firstRun)
            {
             ...
             //   var intent = new Intent(MediaStore.ActionImageCapture);
              // intent.PutExtra(MediaStore.ExtraOutput, "content:///"+(jFile));
               ...
               mOnImageAvailableListener = new ImageAvailableListener(this, jFile);
                firstRun = false;
            }
        }
        ...
        private void RequestCameraPermission()
        {
            ...
            if (FragmentCompat.ShouldShowRequestPermissionRationale(this, Manifest.Permission.ReadExternalStorage))
            {
                string[] permissions = {
